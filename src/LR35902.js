...
//     function concat(r,c,childNodes) {
//     let comm = "";
//         let setFlag = "";
//         if (childNodes.length > 4) {
//             let flag = childNodes[4].textContent; 
//             comm = "//"+childNodes[0].textContent+"    "+childNodes[2].textContent+"    "+flag;
//             //if (flag != "- - - -") 
//             setFlag = flag.split(" ").filter(f=>f!="-").map(f=> "ZNHC".indexOf(f)==-1?"//"+f:"    "+f+" = 1;").join("\n");
//         }
//         return "case 0x"+r.toString(16).toUpperCase()+c.toString(16).toUpperCase()+":"+ comm+"\n" +setFlag+ "\nbreak;\n"
//     }
...
//                                                                 .reduce((obj, td, itd) => set(obj, td.attributes['bgcolor'], concat(itr,itd,td.childNodes)), {})
//                     ), {});
    
//     console.log(
//         Object.keys(obj).reduce((str, bgcolor) => str + "\n// " + legend[bgcolor] + "\n" + obj[bgcolor].reduce((_str, s) => _str + s, ""), "")
//     )         
// })();
